...
var getDeviceId = function (callback) {
    var hash = cookie.readCookie('reco-deviceId');
    ...
    new Fingerprint2().get(function (result, components) {
        if (result !== hash) cookie.createCookie('reco-deviceId', result, 90);
        if(callback) callback(hash);
    });
};
...
var collectData = function () {
    ...
    $.each($itemprop, function () {
        var $this = $(this),
            key = $this.attr('itemprop'),
            value = $this.text();
...
//call authorize to get token and save it in cookie
var getToken = function(callback) {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: 'https://f-collect.azurewebsites.net/api/token',
        data: JSON.stringify({ username: "fUser2", password: "fPassword2" }),
        dataType: "json"
...
var sendData = function(deviceId, token, data) {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: 'https://f-collect.azurewebsites.net/api/collection',
        data: JSON.stringify({ deviceId: deviceId, productTitle: data.name}),
        dataType: "json",
...
var saveData = function() {
    getDeviceId(function(deviceId) {
        ...
        getToken(function(token) {
            sendData(deviceId, token, data);
        });
    });
};

var loadData = function(deviceId, token, callback) {
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: 'https://f-collect.azurewebsites.net/api/recommendations/' + deviceId,
        dataType: "json",
        beforeSend: function (xhr) {
            /* Authorization header */
            xhr.setRequestHeader("Authorization", "Bearer " + token);
...
var getData = function(callback) {
    getDeviceId(function(deviceId) {
        getToken(function(token) {
            loadData(deviceId, token, function(list) {
                if(callback) callback(list);
            });
        });
    });
...
},{"./tools/cookie":4,"fingerprintjs2":1}],4:[function(require,module,exports){
'use strict';
...
global.recoAPI = require('./components/data');

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./components/data":3,"jquery":2}]},{},[5]);
